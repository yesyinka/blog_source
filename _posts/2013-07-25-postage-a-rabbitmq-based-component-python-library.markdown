...
comments: true
categories: [python, pika, rabbitmq, postage]
---
...
{% include_code lang:python postage/facilities.py %}
{% include_code lang:python postage/send_ping.py %}
{% include_code lang:python postage/receive_ping.py %}
